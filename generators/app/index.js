...
module.exports = generators.Base.extend({
  ...
  prompting: function () {
    ...
    var prompts = [
      ...
      //   type: 'confirm',
      //   name: 'needES6',
      //   message: 'Do you need ECMAScript 6?',
      //   default: this.needES6
      // },
      {
        type: 'confirm',
        name: 'needRedux',
  ...
  default: function () {
    ...
    this.composeWith('react-web-app:src', {
      options: {
        projectName: this.projectName,
        cssPreProcessor: this.cssPreProcessor,
        needRedux: this.needRedux
      }
    });
  },
  ...
  _copyPackageJson: function () {
    ...
    this._addReduxDependencies(pkg);
  ...
  _addReduxDependencies: function (pkg) {
    utils.debug(this, "_addReduxDependencies");
